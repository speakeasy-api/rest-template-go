...
import (
	...
	"faceittechtest/internal/errors"
...
const (
	...
	ErrInvalidEmail = app.Error("invalid_email: email is invalid")
	// ErrEmailAlreadyUsed is returned when the email address is already used via another user
	ErrEmailAlreadyUsed = app.Error("email_already_used: email is already in use")
	// ErrEmptyNickname is returned when the nickname is empty
	ErrEmptyNickname = app.Error("empty_nickname: nickname is empty")
	// ErrNicknameAlreadyUsed is returned when the nickname is already used via another user
	ErrNicknameAlreadyUsed = app.Error("nickname_already_used: nickname is already in use")
	// ErrEmptyPassword is returned when the password is empty
	ErrEmptyPassword = app.Error("empty_password: password is empty")
	// ErrEmptyCountry is returned when the country is empty
	ErrEmptyCountry = app.Error("empty_country: password is empty")
	// ErrInvalidID si returned when the ID is not a valid UUID or is empty
	ErrInvalidID = app.Error("invalid_id: id is invalid")
	// ErrUserNotUpdated is returned when a record can't be found to update
	ErrUserNotUpdated = app.Error("user_not_updated: user record wasn't updated")
	// ErrUserNotDeleted is returned when a record can't be found to delete
	ErrUserNotDeleted = app.Error("user_not_deleted: user record wasn't deleted")
	// ErrInvalidFilters is returned when the filters for finding a user are not valid
	ErrInvalidFilters = app.Error("invalid_filters: filters invalid for finding user")
)
