...
import (
	"context"
	"errors"
	errs "faceittechtest/internal/errors"
	"faceittechtest/internal/events"
	"faceittechtest/internal/users"
	"faceittechtest/internal/users/mocks"
...
func TestUsers_FindUsers_Error(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantErr1: errs.ErrUnknown,
			wantErr2: errs.ErrUnknown,
		},
		{
